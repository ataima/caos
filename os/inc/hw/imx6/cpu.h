...
using namespace caArmCpu {
    ...
    extern u32 GetControl(eReq v);
    extern void SetControl(eReq v, u32 value);
    extern void GetMainIdCpuInfo(void);
    extern void DumpRegs(CpuRegs *regs);
    extern void GetRegs(CpuRegs *regs);

    extern void Dump(u32 *addr);
    extern void DumpCPSR(void);
    extern void JumpTo(u32 addr);
    extern void CopyRegsFromStack(u32 *ptr, CpuRegs *regs);
    extern void CopyRegsToStack(u32 *ptr, CpuRegs *regs);
