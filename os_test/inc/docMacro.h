...
#define _PROJECT(a)		{result[currentTest]->add(const_cast<char *>("Doc"),const_cast<char *>("Project"),a);}
#define _REV(a)		        {result[currentTest]->add(const_cast<char *>("Doc"),const_cast<char *>("Revision"),a);}
